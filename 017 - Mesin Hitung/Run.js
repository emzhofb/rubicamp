...
mh.add(3)
  .multiply(4)
  .divide(6)
  .result(); // current result is 2 then the mhutate is : 6 + 3 * 4 / 6 = 6
...
mh.multiply(2)
  .multiply(Pi)
  .result(); // keliling lingkaran dengan jari jari 7 => 2 x Pi x r = 44

mh.x = 7; // set jari jari 7

mh.square()
  .multiply(Pi)
  .result(); // keliling lingkaran dengan jari jari 7 => Pi x r pangkat 2 = 154
